...
/*
    function canvas_init() {
        ...
        //latScale = (centerLat - xToLat(latToX( centerLat,zoomLevel) + w/2, zoomLevel))/250; //I have no idea what this 250 is for, but it seems to fix things... :\
...
//	console.log("merc_o_x " + mercator_origin.x);
//	console.log("merc_o_y " + mercator_origin.y);
	//initial_translate_x = (world_translate_x - centerLong);
        //initial_translate_y = (world_translate_y - centerLat);
        //tx_translate_x = mercator_origin.x;// + w/2;
        //tx_translate_y = mercator_origin.y;// + h/2;
...
//	console.log("w_lat " + w_lat);

        latScale = (w_lat_high - w_lat_low) / h;
	//latScale = longScale;//(centerLat - w_lat) / 256; 
	//latScale = (centerLat - xToLat(latToX( centerLat,zoomLevel) + w/2, zoomLevel)) / 256; 
        for(pt in pts){
            var p = pts[pt];
            var p2 = {x:0, y:0};
...
//        console.log(merc_pts);
//        console.log(merc_cam_pts);

	draw();

	//console.log("centerLong " + centerLong);
//	console.log("centerLat " + centerLat);
//	console.log("longScale " + longScale);
//	console.log("latScale " + latScale);
//	console.log("tx_x " + tx_translate_x);
//	console.log("tx_y " + tx_translate_y);
    }
...
//        ctx.translate(tx_translate_x + dtx_translate_x,
//                      tx_translate_y + dtx_translate_y);
...
/*
        ...
        ctx.fillRect(w/2-dp/2,h/2-dp/2,dp,dp);
